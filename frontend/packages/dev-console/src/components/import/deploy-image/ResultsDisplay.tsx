            ...
            <div className="co-image-name-results__details">
              {runsAsRoot(values.isi.image) && (
                <Alert isInline className="co-alert" variant="warning" title="Image runs as root">
                  Image <strong>{values.isi.name}</strong> runs as the <strong>root</strong> user
                  which might not be permitted by your cluster administrator.
                </Alert>
              )}
              <div className="row">
                    ...
                    <small>
                      ...
                      {_.get(values.isi, 'image.dockerImageMetadata.Size') && (
                        <span>
                          {
                            units.humanize(
                              values.isi.image.dockerImageMetadata.Size,
                              'binaryBytes',
                              true,
                            ).string
                          }
